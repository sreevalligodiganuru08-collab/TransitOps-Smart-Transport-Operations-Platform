(function () {
    ...
    // ======================================================
    // Fuel / Expense search (no status filter on these pages)
    // ======================================================

    function wireSimpleSearch(searchId, tbodyId, countId) {
    ...
    wireSimpleSearch("fuelSearch", "fuelTableBody", "fuelCount");
    wireSimpleSearch("expenseSearch", "expenseTableBody", "expenseCount");
    ...
    function wireCargoValidation(vehicleSelectId, cargoInputId, errorElId) {
        ...
        const cargoInput = $("#" + cargoInputId);
        const errorEl = $("#" + errorElId);
        if (!vehicleSelect || !cargoInput) return;

        const group = cargoInput.closest(".form-group");

        function validate() {
            const selectedOption = vehicleSelect.options[vehicleSelect.selectedIndex];
            const capacity = selectedOption ? parseFloat(selectedOption.getAttribute("data-capacity")) : NaN;
    ...
    $all(".delete-link").forEach(function (link) {
        link.addEventListener("click", function (e) {
            const message = link.getAttribute("data-confirm") || "Delete this record? This cannot be undone.";
